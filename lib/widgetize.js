...
var widgetize = module.exports = function widgetize(name, clazz, template, options) {
	...
	var config = {prototype: delegate(clazz).prototype}; 
...
function delegate(Target) {
	...
	Delegate.__super__ = Target;

	var proto = {};
	for (var prop in Target.prototype)
	{
		var desc = Object.getOwnPropertyDescriptor(Target.prototype, prop);
console.info(desc);
		Object.defineProperty(proto, prop, {
			get: function () {
				return Delegate.__super__.prototype[prop];
			},
			set: function(value) {
				Delegate.__super__.prototype[prop] = value;
			}
		});
	}

	Delegate.prototype = proto;

	if (Target.prototype.detach)
	{
		Delegate.prototype.detach = function(dom) {
			console.log('Hi');
			Delegate.super_.prototype.detach.call(this, dom);	
		};
	}
